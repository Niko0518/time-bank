...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const kpiInfoBtn = document.getElementById('kpiDashboardInfoButton');
    if (kpiInfoBtn && localStorage.getItem('kpiDashboardInfoHidden') === 'true') {
        kpiInfoBtn.style.display = 'none';
    }
    const chartInfoBtn = document.getElementById('chartAnalysisInfoButton');
    if (chartInfoBtn && localStorage.getItem('chartAnalysisInfoHidden') === 'true') {
        chartInfoBtn.style.display = 'none';
    }
